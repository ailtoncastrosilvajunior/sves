...
Rails.application.configure do
  ...
  # Active Storage: em PaaS (ex.: DO App Platform) o disco local não é fiável — redeploy apaga ficheiros.
  # Produção com object storage: ACTIVE_STORAGE_SERVICE=digitalocean_spaces + variáveis DO_SPACES_* (ver storage.yml).
